...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        x, relu_cache = affine_relu_forward(x, W2, b2)
        scores, last_cache = affine_forward(x, W3, b3)
        ...
        dx, grads['W3'], grads['b3'] = affine_backward(dx, last_cache)
        grads['W3'] += self.reg * W3
        dx, grads['W2'], grads['b2'] = affine_relu_backward(dx, relu_cache)
